...
import {
  publicModalities as modalities,
  normalizeClass,
...
async function submit(e) {
  ...
  try {
    await rpc("interclasse_register", {
      p_modality: active.modalityId || active.id,
      p_name: name,
      p_class: className,
      p_event: f.get("event") || null,
      p_division: active.division || null,
    });
    room = className;
